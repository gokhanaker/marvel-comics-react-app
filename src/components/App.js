...
class App extends Component {
    ...
    state = {superHeroId: 0, superHeroName: null , superHeroDescription: null , superHeroImage: null, superHeroComics: []}
    ...
    render(){
        ...
        return (
            <div id = "searchSuperHero" >
                ...
                <input id = 'search-bar' placeholder = 'search a marvel superhero'
